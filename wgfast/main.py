...
def main(argv=None):
    ...
    run_wgfast(options.reference_dir, options.read_directory,
...
def run_wgfast(reference_dir,read_directory,processors,coverage,proportion,keep,subsample,
